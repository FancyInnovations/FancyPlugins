...
import de.oliver.fancynpcs.v26_4.attributes.Attributes_26_4;
...
public class AttributeManagerImpl implements AttributeManager {
    ...
    private void init() {
        ...
        switch (mcVersion) {
            case "26.4 Snapshot 1" -> attributes = Attributes_26_4.getAllAttributes();
            case "26.3" -> attributes = Attributes_26_3.getAllAttributes();
