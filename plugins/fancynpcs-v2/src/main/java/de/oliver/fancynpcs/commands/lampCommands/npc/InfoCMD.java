...
public final class InfoCMD extends FancyContext {
    ...
    @CommandPermission("fancynpcs.command.npc.info")
    public void onInfo(
        ...
        final String visibilityDistanceTranslated = (npc.getData().getVisibilityDistance() == -1)
                ? ((SimpleMessage) translator.translate("default").replace("value", String.valueOf(config.getVisibilityDistance()))).getMessage()
